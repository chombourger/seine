...
# Waits for the console stream to go quiet before disconnect() stops
# it -- stopping mid-burst cuts each recording's tail. Bounded, and
# free when idle: nothing recent in flight skips the loop entirely.
_DRAIN_QUIET = 0.3
_DRAIN_CAP = 1.5
