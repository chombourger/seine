...
# Log panes are RichLog/Static widgets, not terminals: an escape
# sequence in tailed text would draw on the real terminal instead,
# escaping its pane. Everything tailed goes through here first.
