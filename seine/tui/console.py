...
# tail: end at the last row holding output, not the screen bottom,
# so a pane shorter than the full screen shows the newest output. A
# short session still starts at the top instead of showing blanks.
