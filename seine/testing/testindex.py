...
# render_test_node() calls scan() several times a second while a run
# is live; cache it briefly. Keyed by logs_root() too, not just time,
# so isolated tests (each its own SEINE_LOG_DIR) never share a result.
_SCAN_CACHE_TTL = 2.0
